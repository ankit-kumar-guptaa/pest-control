...
<head>
  <meta charset="utf-8" />
  <title>Modern Pest Control</title>
...
<body>
        ...
        <div class="carousel-item active">
          ...
          <div class="carousel-caption">
            <div class="container carousel-content">
              ...
              <a href="" class="me-2"><button type="button" class="px-5 py-3 btn btn-primary border-2 rounded-pill animated slideInDown">
                  Read More
                </button></a>
            </div>
          </div>
              ...
              <div class="row g-4">
                <div class="col-md-6 col-xl-3">
                  <select class="form-select p-3 border-0">
                    <option value="Type Of Service" class="">
                      Type Of Service
                    </option>
      ...
      <div class="row g-5">
        ...
        <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".6s mb-5">
          <div class="about-item overflow-hidden">
            ...
            <button type="button" class="btn btn-primary border-0 rounded-pill px-4 py-3 mt-5">
              Find Services
            </button>
          </div>
        </div>
        <!-- <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".6s"">
          <h2 class=" display-5 mb-2">Who We Are</h2>
          <p class="fs-5" style="text-align: justify">Our Pest Management Services are safe, environment friendly and incur no adverse effect on human life. We are a team of pest management experts in Delhi providing Pest Control to Home, Offices, Industries, Hotels and Corporate Hubs of Delhi. Our pest/termite control services are effective in both aspects, cost wise and quality wise.</p>
          <button href="contact.php" type="button" class="btn btn-primary border-0 rounded-pill px-4 py-3 mt-2">
            Contact Us
          </button>
          <div class="col-md-12">
            <div style="margin-top:21pt;">
              <iframe width="100%" height="315" src="https://www.youtube.com/embed/yj68BmlGgqU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" __idm_id__="737281"></iframe>
            </div>
          </div>
        </div> -->
        <div class="row mt-5">
          <div class="col-12 col-md-6 wow fadeInUp mt-5" data-wow-delay=".6s">
            <!-- <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay=".6s"> -->
              <h2 class="display-5 mb-2">Who We Are</h2>
              <p class="fs-5" style="text-align: justify"> Our Pest Management Services are safe, environment friendly and incur no adverse effect on human life. We are a team of pest management experts in Delhi providing Pest Control to Home, Offices, Industries, Hotels and Corporate Hubs of Delhi. Our pest/termite control services are effective in both aspects, cost wise and quality wise. </p>
              <button href="contact.php" type="button" class="btn btn-primary border-0 rounded-pill px-4 py-3 mt-2">
          ...
          <div class="col-12 col-md-6 wow mt-5">
              <iframe width="100%" height="350px" src="https://www.youtube.com/embed/yj68BmlGgqU" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="" __idm_id__="737281"></iframe>
  ...
  <div class="container-fluid services py-5">
    <div class="container text-center py-5">
      ...
      <div class="row g-5">
        <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".3s">
          <div class="bg-light rounded p-5 services-item">
            <div class="d-flex" style="align-items: center; justify-content: center">
              ...
              <img src="img/mosquito.png" alt="">
                <!-- <i class="fa-solid fa-mosquito fa-3x text-primary"></i> -->
              </div>
            </div>
            <h4>Mosquitoes Control</h4>
            <p class="fs-5">
            Modern Pest Control Services  offer reliable service of Mosquitoes.....
            </p>
            <button type="button" class="btn btn-primary border-0 rounded-pill px-4 py-3">
              Learn More
            </button>
          </div>
        </div>
        <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".5s">
          <div class="bg-light rounded p-5 services-item">
            <div class="d-flex" style="align-items: center; justify-content: center">
              <div class="mb-4 rounded-circle services-inner-icon">
              <img src="img/termite.png" alt="">
                <!-- <i class="fa fa-spider fa-3x text-primary"></i> -->
              </div>
            </div>
            <h4 class="text-center">Termite Control</h4>
            <p class="text-center fs-5">
            Modern Pest Control Services  offer an reliable service of Termite Control in Delhi.....
            </p>
            <button type="button" class="btn btn-primary border-0 rounded-pill px-4 py-3">
              Learn More
            </button>
        ...
        <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".7s">
          <div class="bg-light rounded p-5 services-item">
            <div class="d-flex" style="align-items: center; justify-content: center">
              <div class="mb-4 rounded-circle services-inner-icon">
                <img src="img/cockroach.png" alt="">
                <!-- <i class="fa fa-spider fa-3x text-primary"></i> -->
              </div>
            </div>
            <h4 class="text-center">Cockroaches Control</h4>
            <p class="text-center fs-5">
            Modern Pest Control Services  service of Cockroaches Control..
            </p>
            <button type="button" class="btn btn-primary border-0 rounded-pill px-4 py-3">
              Learn More
            </button>
        ...
        <div class="col-xxl-3 col-lg-6 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".9s">
          <div class="bg-light rounded p-5 services-item">
            <div class="d-flex" style="align-items: center; justify-content: center">
              <div class="mb-4 rounded-circle services-inner-icon">
              <img src="img/residential-pest.png" alt="">
                <!-- <i class="fa fa-spider fa-3x text-primary"></i> -->
              </div>
            </div>
            <h4 class="text-center">Residential Pest Control </h4>
            <p class="text-center fs-5">
            Modern Pest Control Services  offer Residential Pest Control in Delhi....
            </p>
            <button type="button" class="btn btn-primary border-0 rounded-pill px-4 py-3">
              Learn More
            </button>
      ...
      <button type="button" class="btn btn-primary border-0 rounded-pill px-4 py-3 mt-4 wow fadeInUp" data-wow-delay=".3s">
        More Services
      </button>
    </div>
  </div>
          ...
          <form method="post" action="index.html">
            <div class="form-group">
              <div class="d-flex call-btn">
                ...
                <button type="email" value="Search Now!" class="btn btn-primary border-0 rounded-pill rounded rounded-start px-5">
                  Subscribe
                </button>
              </div>
            </div>
      ...
      <div class="row g-5">
        <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".3s">
          <div class="rounded bg-light pricing-item">
            ...
            <div class="px-4 py-5 text-center bg-primary pricing-label mb-2">
              <h1 class="mb-0">
                $60<span class="text-secondary fs-5 fw-normal">/mo</span>
              </h1>
              <p class="mb-0">Basic Pest Control</p>
            </div>
            <div class="p-4 text-center fs-5">
              <p>
                <i class="fa fa-check text-success me-2"></i>Household pests
                Control
              </p>
              <p>
                <i class="fa fa-check text-success me-2"></i>Rodent Control
              </p>
              <p>
                <i class="fa fa-check text-success me-2"></i>Re-Service at
                No-Charge
              </p>
              <p>
                <i class="fa fa-times text-danger me-2"></i>Termite Control
              </p>
              <p>
                <i class="fa fa-times text-danger me-2"></i>Mosquito Reduction
              </p>
              <button type="button" class="btn btn-primary border-0 rounded-pill px-4 py-3 mt-3">
                Get Started
              </button>
            </div>
          </div>
          ...
          <div class="rounded bg-light pricing-item">
            ...
            <div class="px-4 py-5 text-center bg-dark pricing-label pricing-featured mb-2">
              <h1 class="mb-0 text-primary">
                $80<span class="fs-5 fw-normal">/mo</span>
              </h1>
            ...
            <div class="p-4 text-center fs-5">
              ...
              <p>
                <i class="fa fa-check text-success me-2"></i>Termite Control
              </p>
              <p>
                <i class="fa fa-times text-danger me-2"></i>Mosquito Reduction
              </p>
              <button type="button" class="btn btn-dark border-0 text-primary rounded-pill px-4 py-3 mt-3">
                Get Started
              </button>
            </div>
          </div>
        ...
        <div class="col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay=".7s">
          <div class="rounded bg-light pricing-item">
            ...
            <div class="px-4 py-5 text-center bg-primary pricing-label mb-2">
              <h1 class="mb-0">
                $120<span class="text-secondary fs-5 fw-normal">/mo</span>
              </h1>
            ...
            <div class="p-4 text-center fs-5">
              ...
              <p>
                <i class="fa fa-check text-success me-2"></i>Mosquito
                Reduction
              </p>
              <button type="button" class="btn btn-primary border-0 rounded-pill px-4 py-3 mt-3">
                Get Started
      ...
      <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay=".5s">
        <div class="testimonial-item">
          <div class="testimonial-content rounded mb-4 p-4">
            <p class="fs-5 m-0">
            Pest Control is the real deal! They tackled our termite issue swiftly and saved our property. Fantastic team
            </p>
          </div>
          <div class="d-flex align-items-center mb-4" style="padding: 0 0 0 25px">
            ...
            <div class="ms-3">
              <h4 class="mb-0">Military Engineering Services</h4>
        ...
        <div class="testimonial-item">
          <div class="testimonial-content rounded mb-4 p-4">
            <p class="fs-5 m-0">
            A big thank you to Pest Control for their prompt and professional service. Pests don't stand a chance
            </p>
          </div>
          <div class="d-flex align-items-center mb-4" style="padding: 0 0 0 25px">
            <div class="position-relative">
            ...
            <div class="ms-3">
              <h4 class="mb-0">Netaji Subhas  Institute Of Technology</h4>
              <p class="mb-1">Profession</p>
              <div class="d-flex">
                <small class="fas fa-star text-primary me-1"></small>
                <small class="fas fa-star text-primary me-1"></small>
        ...
        <div class="testimonial-item">
          <div class="testimonial-content rounded mb-4 p-4">
            <p class="fs-5 m-0">
            "Pest Control delivered exceptional results, eliminating our pest problem efficiently. Highly recommended!
            </p>
          </div>
          <div class="d-flex align-items-center mb-4" style="padding: 0 0 0 25px">
            <div class="position-relative">
            ...
            <div class="ms-3">
              <h4 class="mb-0">Public Department</h4>
              <p class="mb-1">Profession</p>
              <div class="d-flex">
                <small class="fas fa-star text-primary me-1"></small>
                <small class="fas fa-star text-primary me-1"></small>
        ...
        <div class="testimonial-item">
          <div class="testimonial-content rounded mb-4 p-4">
            <p class="fs-5 m-0">
            Fast, friendly, and effective pest management! Pest Control saved our home from an ant invasion.
            </p>
          </div>
          <div class="d-flex align-items-center mb-4" style="padding: 0 0 0 25px">
            <div class="position-relative">
